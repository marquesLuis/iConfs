...
-(void) createDatabases{
    ...
    //Events
    [self createOrOpenDB:"CREATE TABLE IF NOT EXISTS EVENTS( ID INTEGER PRIMARY KEY AUTOINCREMENT, TITLE TEXT, DESCRIPTION TEXT, SERVER_ID INTEGER, KIND TEXT, BEGIN TEXT, END TEXT, DURATION INTEGER, DATE TEXT, LOCATION_ID INTEGER, SPEAKER_ID INTEGER, KEYNOTE INTEGER)" WithName:@"events.db"];
    ...
    [self createOrOpenDB:"CREATE TABLE IF NOT EXISTS EVENT_LOCAL( ID INTEGER PRIMARY KEY AUTOINCREMENT, EVENT_ID INTEGER, LOCAL_ID INTEGER)" WithName:@"event_local.db"];
